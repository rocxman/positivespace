    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-dark-950">
      ...
      <Card className="w-full max-w-md relative z-10">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start creating amazing music with AI</CardDescription>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500">3-30 characters, letters, numbers, and underscores only</p>
            </div>
